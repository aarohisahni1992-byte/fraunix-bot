    ...
    try {
      ...
      await interaction.editReply({
        embeds: [premiumEmbed({
          ...
          description: [
            ...
            `\`${D.v}  ${badge('green', 'LOCK')}  🔒  Channel locked            ${D.v}\``,
      ...
      await channel.send({
        embeds: [premiumEmbed({
          ...
          description: [
            `\`${D.tl}${D.thinH.repeat(24)}${D.tr}\``,
            `\`${D.v}  🔒  This channel has been locked      ${D.v}\``,
            `\`${D.sep}${D.thinH.repeat(24)}${D.sep2}\``,
      ...
      await interaction.editReply({ embeds: [errorEmbed(`Failed to lock: ${error.message}`, 'Lock Failed')] });
    }
  }
};
